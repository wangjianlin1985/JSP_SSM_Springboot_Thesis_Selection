		       ...
		       text: "论文题目管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    url: "Subject/subject_teacherAdd.jsp"
			    	   	},
			    		{
			    	   		text: "我发布的论文题目",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Subject/subject_teacherQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "学生选题管理",
			    	   ...
			    	   [
			    		{
			    	   		...
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SubSelect/subSelect_teacherQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "学生成果管理",
			    	   ...
			    	   [
			    		{
			    	   		...
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Opus/opus_teacherQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "答辩视频管理",
