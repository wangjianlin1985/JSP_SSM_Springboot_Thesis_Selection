...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">毕业论文选题网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Teacher/frontlist">教师查询</a></li> 
                ...
                <li><a href="<%=basePath %>Leaveword/frontlist">留言提问</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>SubSelect/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的论文选题</a></li>
                        <li><a href="<%=basePath %>Opus/opus_frontUserAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;提交我的论文成果</a></li>
                        <li><a href="<%=basePath %>Opus/userFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我的论文成果查询</a></li>
