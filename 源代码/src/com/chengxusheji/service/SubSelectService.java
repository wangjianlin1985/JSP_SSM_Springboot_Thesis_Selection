...
public class SubSelectService {
    ...
    /*老师按照查询条件分页查询学生选题记录*/
    public ArrayList<SubSelect> teacherQuerySubSelect(String teacherNo,UserInfo userObj,String selectTime,String shenHeState,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(null != teacherNo)  where += " and t_teacher.teacherNo='" + teacherNo + "'";
    	if(null != userObj &&  userObj.getUser_name() != null  && !userObj.getUser_name().equals(""))  where += " and t_subSelect.userObj='" + userObj.getUser_name() + "'";
    	if(!selectTime.equals("")) where = where + " and t_subSelect.selectTime like '%" + selectTime + "%'";
    	if(!shenHeState.equals("")) where = where + " and t_subSelect.shenHeState like '%" + shenHeState + "%'";
    	int startIndex = (currentPage-1) * this.rows;
    ...
    /*老师再当前查询条件下计算总的页数和记录数*/
    public void teacherQueryTotalPageAndRecordNumber(String teacherNo,UserInfo userObj,String selectTime,String shenHeState) throws Exception {
     	String where = "where 1=1";
    	if(null != teacherNo)  where += " and t_teacher.teacherNo='" + teacherNo + "'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_subSelect.userObj='" + userObj.getUser_name() + "'";
    	if(!selectTime.equals("")) where = where + " and t_subSelect.selectTime like '%" + selectTime + "%'";
